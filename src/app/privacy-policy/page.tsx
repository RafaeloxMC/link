	...
	return (
		<div className="flex flex-col w-full h-full items-center justify-center">
			<div className="flex flex-col justify-center items-center">
				<h1 className="text-8xl text-center font-bold drop-shadow-glow_xl w-full h-full items-center justify-center mt-10 mb-5">Privacy Policy</h1>
			</div>
			<HiHome
				className="text-4xl"
				onClick={() => {
			...
			/>
			<div className="flex flex-col w-full h-full justify-center text-left p-10 gap-y-2">
				...
				<ul>
					...
					<li>
						<p>
							<strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to xvcf.
						</p>
					</li>
					<li>
						<p>
					...
					<li>
						<p>
							<strong>Website</strong> refers to xvcf, accessible from{" "}
							<a href="https://xvcf.dev" rel="external nofollow noopener" target="_blank">
								https://xvcf.dev
							</a>
						</p>
					</li>
				...
				<h4 className="text-xl">Tracking Technologies and Cookies</h4>
				...
				<h4 className="text-xl">Business Transactions</h4>
				<p>If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.</p>
				<h4 className="text-xl">Law enforcement</h4>
				<p>Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).</p>
				<h4 className="text-xl">Other legal requirements</h4>
